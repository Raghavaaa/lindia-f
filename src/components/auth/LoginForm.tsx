...
export default function LoginForm() {
  ...
  return (
    <Card className="border border-white/60 shadow-xl bg-white/40 backdrop-blur-sm rounded-xl sm:rounded-2xl">
      <CardContent className="p-5 sm:p-6 space-y-4 sm:space-y-5">
        {/* Google Login Button */}
        <Button
          type="button"
          variant="outline"
          className="w-full h-10 sm:h-11 text-sm sm:text-base border border-gray-300 hover:border-gray-400 bg-white/80 hover:bg-white/90 shadow-md hover:shadow-lg transition-all duration-200 rounded-lg sm:rounded-xl font-medium"
        ...
        <form onSubmit={handleEmailLogin} className="space-y-4 sm:space-y-5">
          <div className="space-y-2">
            ...
            <Input
              ...
              className="h-10 sm:h-11 text-sm sm:text-base border border-gray-300 focus:border-gray-500 focus:ring-gray-500 bg-white/80 backdrop-blur-sm rounded-lg sm:rounded-xl"
              required
            />
          </div>
